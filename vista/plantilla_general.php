...
<head>
    ...
    <link href="../librerias/css/topbar.css" rel="stylesheet">
...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="https://logodownload.org/wp-content/uploads/2015/04/whatsapp-logo-1.png" alt="user">
                                            </div>
                                            <div class="u-text">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav active">
                    <ul id="sidebarnav" class="in">
                        ...
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-barcode"></i><span
                                    class="hide-menu">Solicitudes</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li id="opcion_nueva"><a href="vista_solicitudes_nuevas.php">Solicitudes Nuevas</a></li>
                                <li><a href="fabricantes.php">Solicitudes Aceptadas</a></li>
								<li><a href="fabricantes.php">Solicitudes Rechazadas</a></li>
        ...
        <div class="page-wrapper" style="min-height: 600px;">        <!-- 352 -->
           ...
           // include_once('vista_solicitudes_nuevas.php');
               //include_once('vista_solicitudes_aceptadas.php');
               include_once('vista_solicitudes_rechazadas.php');

           // include_once('tabla.php'); ///yiel('')
